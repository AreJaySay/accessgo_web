...
class CreatePassSlip extends StatefulWidget {
  final Map details;
  CreatePassSlip({required this.details});
  @override
  State<CreatePassSlip> createState() => _CreatePassSlipState();
}

class _CreatePassSlipState extends State<CreatePassSlip> with SingleTickerProviderStateMixin {
